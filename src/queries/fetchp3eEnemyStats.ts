...
import { P3EEnemyStats } from "src/interfaces.js";
 ...
 * @returns {Promise<P3EEnemyStats[]>} A promise that resolves to an array of objects containing general stats as keys and the accompnaying data as values
 ...
 * @example export interface P3E_EnemyStats {
  level: string;
  hp: string;
  appears: string;
}
