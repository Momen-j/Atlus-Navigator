import { fetchP4EnemyStats } from "./fetchp4EnemyStats";
...
describe("fetchP4EnemyStats", () => {
  it("should return the correct stats for a given enemy", async () => {
    const result = await fetchP4EnemyStats("Shadow");
  ...
  it("should return an empty array when no enemy is found", async () => {
    ...
    const result = await fetchP4EnemyStats("NonExistentEnemy");
