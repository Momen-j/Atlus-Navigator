import { fetchP3E_EnemyWeaknesses } from "./fetchp3eEnemyWeaknesses";
...
describe("fetchP3E_EnemyWeaknesses", () => {
  it("should return the correct weaknesses for a given shadow", async () => {
    const result = await fetchP3E_EnemyWeaknesses("Shadow");
  ...
  it("should return an empty array when no enemy is found", async () => {
    ...
    const result = await fetchP3E_EnemyWeaknesses("NonExistentEnemy");
